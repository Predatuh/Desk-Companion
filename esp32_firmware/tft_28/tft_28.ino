  ...
  if (currentExpression == "heart") {
    ...
    for (int line = 0; line < 3; line++) {
      gfx->drawLine(MX - 16, MY + mShift + line,
                   MX + 16, MY - mShift + line, userMouthColor);
    }
    ...
    for (int line = 0; line < 4; line++) {
      gfx->drawLine(MX - 16, MY + 2 + line,
                   MX + 16, MY - 2 + line, userMouthColor);
    }
    ...
    for (int line = 0; line < 3; line++) {
      gfx->drawLine(MX - 12, MY - lift + line,
                   MX + 12, MY - lift + line, userMouthColor);
    }
...
void loop() {
  ...
  const bool relayPushDue = relayStatusDirty ||
