...
The firmware also stores a pet personality, active pet mode, lightweight companion stats like bond, energy, and boredom, and appearance options like hair, ears, mustache, glasses, headwear, and piercings, plus hair and mustache sizing so the device can keep acting like a small companion when the app is not actively controlling it. The app now has a local live preview for the companion face, expanded mustache and hair options, better grouped behavior/style controls, and it can still send care interactions such as petting, cheering up, comforting, dancing, and surprises while switching the companion fully off or into a latched mode until you change it again.
